...
need('frontend/assets/js/journey.js','Camera unavailable','socket?.disconnect','startGps')
need('backend/src/middleware/auth.js','Invalid or expired access token','401')
need('backend/src/middleware/validate.js','422')
print('FAILURE_CONTRACTS PASS: DB/AI/routing/traffic/email/socket/browser permission/auth/payload failure paths are represented')
