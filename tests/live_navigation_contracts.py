...
need('backend/src/controllers/hazardController.js','safetyEligible','liveRequireValidatedAi','canAffectLive',"journey.status!=='ACTIVE'")
need('backend/src/controllers/hazardMetadataController.js','safetyEligible','liveRequireValidatedAi','canAffectLive',"journey.status !== 'ACTIVE'")
