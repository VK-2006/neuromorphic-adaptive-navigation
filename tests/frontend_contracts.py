...
require('backend/src/controllers/hazardController.js',"Journey.exists({_id:req.body.journeyId,userId:req.user._id})",'You cannot confirm your own hazard report','Nearby confirmation requires a current location within 500 m of the hazard')
