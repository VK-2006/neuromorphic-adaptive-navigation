...
real evaluation set before enabling safety-eligible live AI.
"""
...
def main():
    ...
    print('saved',out/'risk_snn.pt');print('validation remains FALSE; evaluate on a held-out real dataset before live safety use')
