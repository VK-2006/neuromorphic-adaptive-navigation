...
exports.detect=[body('journeyId').optional({nullable:true}).isMongoId(),body('deviceId').optional({nullable:true}).isMongoId(),body('image').isString().isLength({min:20,max:2_800_000}),...coord('location',{optional:true}),body('location.speed').optional({nullable:true}).isFloat({min:0,max:200})];
