...
| Object / road-damage detection | IMPLEMENTED / FUNCTIONAL | BDD100K/RDD2022 prep/train/evaluate utilities, detector taxonomy, TorchScript runtime artifact/readiness checks, confidence filtering, API and OpenCV fallback. Independent cross-dataset detector scientific validation is future work, not a current completion gate. |
| SNN | IMPLEMENTED / AI tests VERIFIED fallback / SCIENTIFIC GATE | snnTorch LIF, temporal encoding, spike/membrane decode, train/evaluate path, retained riskValidated scientific-validation gate and immutable 2025 research lock |
...
| Tests | GENERATED / VERIFIED LOCALLY | Windows Jest 9/9 suites, 25/25 tests; AI Pytest; static/algorithm/compliance suites; consolidated runtime E2E + CI included |
